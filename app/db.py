...
class Database(object):
    ...
    def get_root_twelve_majority(self, root_id, action):
        ...
        with self.Sessionmaker() as session:
            if action == 0:
                """Summarizes all city, state, and date numbers that are associated with an incident_id"""
                ...
                """ Brings the total number of similair incident_ids in the conversations table """
